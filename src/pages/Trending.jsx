...
const Trending = () => {
  ...
  const fetchData = async() => {
    const {data:{results}} = await axios.get(requests.requestTrending)
    setMovies(results)
  }
  return (
    <div className='py-2'>
      <h3 className='w-max mx-auto text-white italic text-4xl bg-gradient-to-r from-gray-700 py-2 px-4 my-2 rounded-xl'>Trending Movies</h3>
